...
`scale_x_upset` is a neat function that does several things at once to create a useful x-axis.
I will now step by step recreate the plot to demonstrate some of the underlying ideas.
...
the categories and genres by `freq`uency or by `degree`.
...
The `UpSetR` package provides a lot conveint helpers around this kind of plot; the main
